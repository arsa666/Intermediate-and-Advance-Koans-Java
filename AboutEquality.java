...
public class AboutEquality {
	...
	static class Car {
		...
		public boolean equals(Object other) {
			...
			/*
			 * Car temp = (Car)other; if(this.name == temp.name &
			 * this.horsepower == temp.horsepower) return true;
			 */
			if (this == other)
				return true;
	...
	public void ownHashCodeImplementationPartTwo() {
		...
		//No becuase two objects who are not equal can not yield the same hash. 
		// If it's valid why is this still not a good idea? Very bad idea!!!
	}
